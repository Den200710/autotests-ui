...
class CreateCourseFormComponent(BaseComponent):
    ...
    def __init__(self, page: Page):
        ...
        self.estimated_title_input = page.get_by_test_id('create-course-form-estimated-time-input').locator('input')
    ...
    def check_visible(self, title: str, estimated_title: str, description: str, max_score: str, min_score: str):
        ...
        expect(self.estimated_title_input).to_have_value(estimated_title)
