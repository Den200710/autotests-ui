...
class CreateCourseExerciseFormComponent(BaseComponent):
    ...
    def __init__(self, page: Page):
        ...
        self.delete_exercise_button = Button(
            page,'create-course-exercise-{index}-box-toolbar-delete-exercise-button', 'Delete_exercise_button'
        )
        self.subtitle = Text(page, 'create-course-exercise-{index}-box-toolbar-subtitle-text', 'Exercise_subtitle')
    ...
    @allure.step('Check visible create course exersice form at "{index}"')
    ...
    @allure.step('Fill create course exersice form at "{index}"')
    def fill(self, index: int, title: str, description: str):
        self.title_input.fill(title, index=index)
        self.title_input.check_have_value(title, index=index)

        self.title_input.fill(description, index=index)
